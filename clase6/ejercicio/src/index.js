...
const personasRepo = new PersonaDaoMemoria();
const persona = new Persona(234, "Juan");
personasRepo.add(persona);
const persona1 = new Persona(235, "Pedro");
...
app.post('/api/personas', async (req, res) => {
    ...
    const persona = new Persona(req.body.dni, req.body.nombre);
